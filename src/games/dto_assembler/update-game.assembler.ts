...
import { UpdateGameOutputDto } from '../dto/update-game.output.dto';

@Injectable()
export class UpdateGameAssembler {
  toEntity(game: Game, dto: UpdateGameInputDto): Game {
    game.name = dto.name;
  ...
  toOutputDto(game: Game): UpdateGameOutputDto {
    const dto = new UpdateGameOutputDto();
